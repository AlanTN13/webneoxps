...
| `public/assets/insights/cover-contexto-negocio-ia.svg` | El prompt no es el problema: la IA necesita contexto del negocio | Ilustración editorial original, 1600×900 | NexOps Radar V2 | Activo original NexOps |
