...
export default function ServicesStacked() {
  const services = [
    ...
    },
    {
      ...
      to: "/servicios/data-visualization",
    },
    {
      ...
      to: "/servicios/ai-infrastructure",
    },
    {
      title: "AI Agents",
      icon: <IconBot />,
    ...
    },
    {
      ...
      to: "/servicios/software-integrations",
    },
    {
      ...
      to: "/servicios/process-automation",
    },
    {
      title: "Front-End & UX",
      icon: <IconMonitor />,
  ...
  return (
    <section
      id="servicios"
      className="bg-gradient-to-b from-white to-slate-50/60 py-16 sm:py-24"
    >
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-slate-600">
            Transformamos tu negocio con soluciones de IA personalizadas que
        ...
        <div className="space-y-4">
          {services.map((s) => (
            <Link key={s.title} to={s.to} className="block group">
              <article
                className="relative overflow-hidden rounded-xl border border-slate-200 bg-white p-5 sm:p-6
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex justify-end">
                      <span className="inline-flex items-center text-xs font-semibold text-indigo-600 group-hover:text-indigo-700">
                        Ver más
                        <svg
                          viewBox="0 0 24 24"
